...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DVFwi9o3.js
var router_DVFwi9o3_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-mTzQ4ORB.css";
var APP_NAME = "Skybound";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "One tap. One more flight through the highlands."
			}
		],
		links: [
			{
...
var $$splitComponentImporter = () => import("./routes-aTQHF9Wy.mjs");
...
//#endregion
export { getRouter, router_DVFwi9o3_exports as t };
